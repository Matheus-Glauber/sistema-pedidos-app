...
public class Endereco implements Serializable {
	...
	private static final long serialVersionUID = -381878017720291694L;
	...
	@ApiModelProperty(value = "Rua referente ao endereço")
	private String logradouro;

	@Column(name = "NUMERO")
	@ApiModelProperty(value = "Número referente ao endereço")
	private String numero;

	@Column(name = "COMPLEMENTO")
	@ApiModelProperty(value = "Complemento referente ao endereço")
	private String complemento;

	@Column(name = "BAIRRO")
	@ApiModelProperty(value = "Bairro referente ao endereço")
